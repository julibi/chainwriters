...
const Root = (styled_components__WEBPACK_IMPORTED_MODULE_2___default().span)`
  font-family: ${_themes__WEBPACK_IMPORTED_MODULE_3__/* .INTER_BOLD */ .UY};
...
`;
const TypeWriter = ({ cursor =true , onFinish , pauseLength =3000 , shouldErase =true , shouldLoop =true , speed =100 , fontSizeDesktop =54 , fontSizeMobile =42 , text  })=>{
