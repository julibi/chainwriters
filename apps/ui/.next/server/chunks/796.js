...
exports.modules = {
  ...
  font-family: ${
    _themes__WEBPACK_IMPORTED_MODULE_3__ /* .FONT_SERIF_BOLD */.UY
  };
...
`;
    const Cursor = styled_components__WEBPACK_IMPORTED_MODULE_2___default()
      .span`
...
`;
    const TypeWriter = ({
      ...
      const { 0: typeForward, 1: setTypeForward } = (0,
      react__WEBPACK_IMPORTED_MODULE_1__.useState)(true);
      const { 0: typedOnce, 1: setTypedOnce } = (0,
