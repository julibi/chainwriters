...
exports.modules = {
  /***/ 2391: /***/ (
    ...
    /* harmony export */ __webpack_require__.d(__webpack_exports__, {
      ...
      /* harmony export */ R1: () =>
        /* binding */ MOONPAGE_COLLECTION_ADDRESS_DEV,
    ...
    const MOONPAGE_DEV_ADDRESS = '0xb849DE17AB1d9D6d96c5146b4C1d19a953135A0B';
...
`;
  ...
  @keyframes animate {
    ...
    100% {
      box-shadow: ${
        _themes__WEBPACK_IMPORTED_MODULE_3__ /* .BASE_BOX_SHADOW */.S0
      };
    }
  }
`;
  ...
  /***/ 3092: /***/ (
    ...
    var jazzicon_default = /*#__PURE__*/ __webpack_require__.n(jazzicon_); // CONCATENATED MODULE: ./components/AccountAvatar.tsx
...
`;
      ...
      (0, external_react_.useEffect)(() => {
        if (address && ref.current) {
          ...
          ref.current.appendChild(
            jazzicon_default()(16, parseInt(address.slice(2, 10), 16))
          );
        }
      }, [address]);
    ...
    var themes = __webpack_require__(5468); // CONCATENATED MODULE: ./components/WalletIndicator.tsx
    const Root = external_styled_components_default().div`
  display: flex;
  justify-content: space-evenly;
  max-width: 320px;
  font-family: ${themes /* FONT_SERIF_BOLD */.UY};
`;
    const ConnectionModalOpener = external_styled_components_default()(
      themes /* PrimaryButton */.KM
    )`
  font-family: ${themes /* FONT_SERIF_BOLD */.UY};
  padding: 1rem;
...
`;
        ...
        if (chain) {
          if (connectors /* supportedChainIds.includes */.KC.includes(chain)) {
            ...
            return /*#__PURE__*/ jsx_runtime_.jsx(Item, {
              children:
                (ref = connectors /* supportedChainMapping */.H[chain]) ===
                  null || ref === void 0
                  ? void 0
                  : ref.name,
            });
        ...
        children: showLoading
          ...
          : /*#__PURE__*/ (0, jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
              children: [
                ...
                address &&
                  chain1 &&
                  connectors /* supportedChainIds.includes */.KC.includes(
                    chain1
                  ) &&
                ...
                chain1 &&
                  ...
                  /*#__PURE__*/ jsx_runtime_.jsx(components_AccountAvatar, {
                    address: address,
                  }),
              ],
            }),
    ...
    /* harmony default export */ const components_WalletIndicator =
      WalletIndicator;
  ...
  /***/ 5680: /***/ (
    ...
    /* harmony import */ var _web3_react_injected_connector__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(6590);
    /* harmony import */ var _web3_react_injected_connector__WEBPACK_IMPORTED_MODULE_0___default =
      /*#__PURE__*/ __webpack_require__.n(
        _web3_react_injected_connector__WEBPACK_IMPORTED_MODULE_0__
      );
    /* harmony import */ var _web3_react_walletconnect_connector__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(9795);
    /* harmony import */ var _web3_react_walletconnect_connector__WEBPACK_IMPORTED_MODULE_1___default =
      /*#__PURE__*/ __webpack_require__.n(
        _web3_react_walletconnect_connector__WEBPACK_IMPORTED_MODULE_1__
      );
    /* harmony import */ var _utils_isProd__WEBPACK_IMPORTED_MODULE_2__ =
    ...
    const supportedChainIds = (0,
    _utils_isProd__WEBPACK_IMPORTED_MODULE_2__ /* .isProd */.B)()
      ? [137]
      : [80001];
    const injected =
      new _web3_react_injected_connector__WEBPACK_IMPORTED_MODULE_0__.InjectedConnector(
        {
          supportedChainIds,
        }
      );
    ...
    const walletconnect =
      new _web3_react_walletconnect_connector__WEBPACK_IMPORTED_MODULE_1__.WalletConnectConnector(
        {
          rpc,
          qrcode: true,
  ...
  /***/ 9826: /***/ (
    ...
    /* harmony export */ __webpack_require__.d(__webpack_exports__, {
      ...
      /* harmony export */ pq: () =>
        /* binding */ DEFAULT_COVER_IMAGE_IPFS_HASH,
      /* harmony export */
    });
    const BLURB_FETCH_ERROR =
      'Something went wrong while loading this blurb. Sorry. Maybe refresh?';
    ...
    const DEFAULT_COVER_IMAGE_IPFS_HASH =
  ...
  /***/ 2024: /***/ (
    ...
    var providers = __webpack_require__(7000); // CONCATENATED MODULE: ./hooks/projects/useProjects.ts
    const useProjects = () => {
      const api = (0, external_react_.useContext)(
        providers /* ProjectsContext */.v5
      );
      if (!api) {
    ...
    var useGetProjectId = __webpack_require__(3275); // CONCATENATED MODULE: ./hooks/projects/index.ts
  ...
  /***/ 5882: /***/ (
    ...
    // EXTERNAL MODULE: external "react"
    var external_react_ = __webpack_require__(6689); // CONCATENATED MODULE: ./abis/AuctionsManager.json
    const AuctionsManager_namespaceObject = JSON.parse(
    ...
    var useContract = __webpack_require__(9214); // CONCATENATED MODULE: ./hooks/useAuctionsManager.ts
    const useAuctionsManager = () => {
      const address =
        process.env.NX_PUBLIC_ENVIRONMENT === 'PROD'
          ? constants /* AUCTIONS_MANAGER_ADDRESS */.A1
          : constants /* AUCTIONS_MANAGER_ADDRESS_DEV */._j;
      const AuctionsManager = (0, useContract /* default */.Z)({
        address,
        abi: AuctionsManager_namespaceObject,
      });
      const AuctionsManagerContract = (0, external_react_.useMemo)(
        () => AuctionsManager,
        [AuctionsManager]
      );
      return AuctionsManagerContract;
    };
    /* harmony default export */ const hooks_useAuctionsManager =
      useAuctionsManager;
  ...
  /***/ 9214: /***/ (
    ...
    /* harmony import */ var _connectors__WEBPACK_IMPORTED_MODULE_3__ =
      __webpack_require__(5680);

    const RPC_URL =
      process.env.NEXT_PUBLIC_ENVIRONMENT === 'DEV'
        ? _connectors__WEBPACK_IMPORTED_MODULE_3__ /* .RPC_URLS[137] */.vl[137]
        : _connectors__WEBPACK_IMPORTED_MODULE_3__ /* .RPC_URLS[80001] */
            .vl[80001];
    const useContract = ({ address, abi }) => {
      const { account, library } = (0,
      _web3_react_core__WEBPACK_IMPORTED_MODULE_1__.useWeb3React)();
      return (0, react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(() => {
        return library && account
          ? new ethers__WEBPACK_IMPORTED_MODULE_2__.Contract(
              address,
              abi,
          ...
          : new ethers__WEBPACK_IMPORTED_MODULE_2__.Contract(
              address,
              abi,
              (0, ethers__WEBPACK_IMPORTED_MODULE_2__.getDefaultProvider)(
                RPC_URL
              )
            );
  ...
  /***/ 7920: /***/ (
    ...
    // EXTERNAL MODULE: external "react"
    var external_react_ = __webpack_require__(6689); // CONCATENATED MODULE: ./abis/MoonpageManager.json
    const MoonpageManager_namespaceObject = JSON.parse(
    ...
    var constants = __webpack_require__(2391);
    // EXTERNAL MODULE: ./hooks/useContract.ts
    var useContract = __webpack_require__(9214); // CONCATENATED MODULE: ./hooks/useMoonpageManager.ts
    const useMoonpageManager = () => {
      const address =
        process.env.NX_PUBLIC_ENVIRONMENT === 'PROD'
          ? constants /* MOONPAGE_MANAGER_ADDRESS */.op
          : constants /* MOONPAGE_MANAGER_ADDRESS_DEV */.$g;
      const MoonpageManager = (0, useContract /* default */.Z)({
        address,
        abi: MoonpageManager_namespaceObject,
      });
      const MoonpageManagerContract = (0, external_react_.useMemo)(
        () => MoonpageManager,
        [MoonpageManager]
      );
      return MoonpageManagerContract;
    };
    /* harmony default export */ const hooks_useMoonpageManager =
      useMoonpageManager;
  ...
  /***/ 7000: /***/ (
    ...
    var external_ethers_ = __webpack_require__(1982); // CONCATENATED MODULE: ./providers/projects-provider/useGetAllProjects.tsx
...
`;
    function useGetAllProjects() {
      const { loading, error, data, refetch } = (0, client_.useQuery)(
        GET_ALL_PROJECTS
      );
        ...
        const formatted =
          projects === null || projects === void 0
            ...
            : projects.map((project) => ({
                ...
                initialMintPrice: external_ethers_.BigNumber.from(
                  project.initialMintPrice
                ),
                premintedByAuthor: external_ethers_.BigNumber.from(
...
`;
    ...
    const ProjectsContext = /*#__PURE__*/ (0, external_react_.createContext)(
      defaultContext
    );
    ...
    var core_ = __webpack_require__(8054); // CONCATENATED MODULE: ./abis/MoonpageCollection.json
    const MoonpageCollection_namespaceObject = JSON.parse(
    ...
    var constants = __webpack_require__(2391);
    // EXTERNAL MODULE: ./hooks/useContract.ts
    var useContract = __webpack_require__(9214); // CONCATENATED MODULE: ./hooks/useMoonpageCollection.ts
    const useMoonpageCollection = () => {
      const address =
        process.env.NX_PUBLIC_ENVIRONMENT === 'PROD'
          ? constants /* MOONPAGE_COLLECTION_ADDRESS */.BI
          : constants /* MOONPAGE_COLLECTION_ADDRESS_DEV */.R1;
      const MoonpageCollection = (0, useContract /* default */.Z)({
        address,
        abi: MoonpageCollection_namespaceObject,
      });
      const MoonpageCollectionContract = (0, external_react_.useMemo)(
        () => MoonpageCollection,
        [MoonpageCollection]
      );
      return MoonpageCollectionContract;
    };
    /* harmony default export */ const hooks_useMoonpageCollection =
      useMoonpageCollection;

    // EXTERNAL MODULE: ./hooks/projects/index.ts + 1 modules
    var projects = __webpack_require__(2024); // CONCATENATED MODULE: ./providers/user-provider/useGetAllNftsOfAccount.ts
    ...
    const useGetAllNftsOfAccount = () => {
      ...
      const { allProjects, areAllProjectsLoading, allProjectsFetchError } = (0,
      projects /* useProjects */.Z)();
      const { 0: balance, 1: setBalance } = (0, external_react_.useState)(0);
      const { 0: nfts, 1: setNfts } = (0, external_react_.useState)([]);
      const { 0: loading, 1: setIsLoading } = (0, external_react_.useState)(
        false
      );
      const { 0: detailedNfts, 1: setDetailedNfts } = (0,
      external_react_.useState)(null);
      const { 0: groupedNfts, 1: setGroupedNfts } = (0,
      external_react_.useState)(null);
      const getProjectIdOfToken = (0, external_react_.useCallback)(
        (tokenId, projects) => {
          const project1 = projects.find(
            (project) =>
              tokenId >= Number(project.startId) &&
              tokenId <= Number(project.endId)
          );
          if (project1) {
            return project1.id;
          } else {
      ...
      const getEditionAndIdOfToken = (0, external_react_.useCallback)(
        (tokenId, projects) => {
          ...
          if (
            ...
            var ref;
            const project2 = projects.find(
              (project) => Number(project.id) === projectId
            );
            if (!project2) return undefined;
            const edition =
              (ref = project2.editions) === null || ref === void 0
                ? void 0
                : ref.find(
                    (ed) =>
                      tokenId >= Number(ed.startId) &&
                      tokenId <= Number(ed.endId)
                  );
      ...
      const fetchBalance = (0, external_react_.useCallback)(async () => {
        try {
          ...
          const groupByProjectId = nftsWithIdAndEdition.reduce(
            (group, product) => {
              const { projectId } = product;
              var _projectId;
              group[projectId] =
                (_projectId = group[projectId]) !== null &&
                _projectId !== void 0
                  ? _projectId
                  : [];
    ...
    /* harmony default export */ const user_provider_useGetAllNftsOfAccount =
      useGetAllNftsOfAccount; // const provider = new JsonRpcProvider(RPC_URLS[80001], 80001); // CONCATENATED MODULE: ./providers/user-provider/user-provider.tsx
    ...
    const UserContext = /*#__PURE__*/ (0, external_react_.createContext)(
      user_provider_defaultContext
    );
    const UserProvider = ({ children }) => {
      const { balance, nfts, isLoading, detailedNfts, groupedNfts } =
        user_provider_useGetAllNftsOfAccount();
      const api = (0, external_react_.useMemo)(
        () => ({
          balance,
          nfts,
    ...
    var isProd = __webpack_require__(3968); // CONCATENATED MODULE: ./components/ToastLink.tsx
...
`;
    ...
    var external_axios_default =
      /*#__PURE__*/ __webpack_require__.n(external_axios_); // CONCATENATED MODULE: ./utils/pinToPinata.ts
    ...
    const pinToPinata = async (hash, projectId, type, title) => {
      ...
      const name = `${
        projectId !== null && projectId !== void 0 ? projectId : title
      }-${type}-${timestamp}`;
      try {
        await external_axios_default().post(
          url,
          {
            hashToPin: hash,
            pinataMetadata: {
    ...
    /* harmony default export */ const utils_pinToPinata = pinToPinata; // CONCATENATED MODULE: ./utils/getGasMargin.ts

    // add 15%
    const getGasMargin = (value) => {
      return value
        .mul(
          external_ethers_.BigNumber.from(10000).add(
            external_ethers_.BigNumber.from(1500)
          )
        )
        .div(external_ethers_.BigNumber.from(10000));
    ...
    const ManagerContext = /*#__PURE__*/ (0, external_react_.createContext)(
      manager_provider_defaultContext
    );
    function ManagerProvider({ children }) {
      const mpManager = (0, useMoonpageManager /* default */.Z)();
      const { 0: configureStatus, 1: setConfigureStatus } = (0,
      external_react_.useState)();
      const { 0: setContributorsStatus, 1: setSetContributorsStatus } = (0,
      external_react_.useState)();
      const { 0: updateTranslationStatus, 1: setUpdateTranslationStatus } = (0,
      external_react_.useState)();
      const { 0: updateBlurbStatus, 1: setUpdateBlurbStatus } = (0,
      external_react_.useState)();
      const { 0: updateTextStatus, 1: setUpdateTextStatus } = (0,
      external_react_.useState)();
      const { 0: enableNextEditionStatus, 1: setEnableNextEditionStatus } = (0,
      external_react_.useState)();
      const configureProject = (0, external_react_.useCallback)(
        async ({
          projectId,
          imgHash,
          animationHash,
          ...
          try {
            ...
            imgHash = imgHash.length
              ? imgHash
              : constants_0 /* DEFAULT_COVER_IMAGE_IPFS_HASH */.pq;
            const estimatedGas =
            ...
            external_react_toastify_.toast.info(
              /*#__PURE__*/ jsx_runtime_.jsx(components_ToastLink, {
                message: 'Configuring...',
              })
            );
            const handleSuccess = () => {
      ...
      const setContributors = (0, external_react_.useCallback)(
        async ({ projectId, contributorsList, onError, onSuccess }) => {
          const addressesArray = [];
          const sharesArray = [];
          const rolesArray = [];
          contributorsList === null || contributorsList === void 0
            ? void 0
            : contributorsList.forEach((contrib) => {
      ...
      const updateTranslation = (0, external_react_.useCallback)(
        async ({ projectId, translationIpfsHash, onError, onSuccess }) => {
          try {
      ...
      const updateBlurb = (0, external_react_.useCallback)(
        async ({
          projectId,
          blurbIpfsHash,
          oldBlurbIpfsHash,
          ...
          try {
            ...
            const estimatedGas =
              await mpManager.estimateGas.updateBlurbIpfsHash(
                projectId,
                blurbIpfsHash
              );
            const gasLimit = getGasMargin(estimatedGas);
      ...
      const updateText = (0, external_react_.useCallback)(
        async ({
          projectId,
          textIpfsHash,
          oldTextIpfsHash,
          ...
          try {
            ...
            const gasLimit = getGasMargin(estimatedGas);
            const Tx = await mpManager.updateTextIpfsHash(
              projectId,
              textIpfsHash,
              {
                gasLimit,
      ...
      const enableNextEdition = (0, external_react_.useCallback)(
        async ({ projectId, price, amount, onError, onSuccess }) => {
          try {
            setEnableNextEditionStatus('confirming');
            const formattedPrice = external_ethers_.BigNumber.from(
    ...
    var useAuctionsManager = __webpack_require__(5882); // CONCATENATED MODULE: ./providers/collection-provider/collection-provider.tsx
    ...
    const CollectionContext = /*#__PURE__*/ (0, external_react_.createContext)(
      collection_provider_defaultContext
    );
    function CollectionProvider({ children }) {
      const collection = hooks_useMoonpageCollection();
      const auctionsManager = (0, useAuctionsManager /* default */.Z)();
      const { 0: startAuctionsStatus, 1: setStartAuctionsStatus } = (0,
      external_react_.useState)();
      const { 0: buyStatus, 1: setBuyStatus } = (0, external_react_.useState)();
      const { 0: mintStatus, 1: setMintStatus } = (0,
      external_react_.useState)();
      const startAuctions = (0, external_react_.useCallback)(
        async ({
          projectId,
          amountForCreator,
          initialMintPrice,
      ...
      const buy = (0, external_react_.useCallback)(
        async ({ projectId, initialMintPrice, onSuccess, onError }) => {
          try {
      ...
      const mint = (0, external_react_.useCallback)(
        async ({ projectId, amount, price, onSuccess, onError }) => {
          try {
    ...
    const AuctionsContext = /*#__PURE__*/ (0, external_react_.createContext)(
      auctions_provider_defaultContext
    );
    function AuctionsProvider({ children }) {
      const auctionsManager = (0, useAuctionsManager /* default */.Z)();
      const { 0: retriggerAuctionStatus, 1: setRetriggerAuctionStatus } = (0,
      external_react_.useState)();
      const retriggerAuction = (0, external_react_.useCallback)(
        async ({ projectId, onSuccess, onError }) => {
          try {
            setRetriggerAuctionStatus('confirming');
            const estimatedGas =
              await auctionsManager.estimateGas.retriggerAuction(
                external_ethers_.BigNumber.from(projectId)
              );
            const gasLimit = getGasMargin(estimatedGas);
    ...
    const MoonpageFactory_namespaceObject = JSON.parse(
    ...
    const useMoonpageFactoryContract = () => {
      const address =
        process.env.NX_PUBLIC_ENVIRONMENT === 'PROD'
          ? constants /* MOONPAGE_FACTORY_ADDRESS */.SA
          : constants /* MOONPAGE_FACTORY_ADDRESS_DEV */.C5;
      const Factory = (0, useContract /* default */.Z)({
        address,
        abi: MoonpageFactory_namespaceObject,
      });
      const FactoryContract = (0, external_react_.useMemo)(
        () => Factory,
        [Factory]
      );
      return FactoryContract;
    };
    /* harmony default export */ const hooks_useMoonpageFactoryContract =
      useMoonpageFactoryContract; // CONCATENATED MODULE: ./providers/factory-provider/factory-provider.tsx

    const factory_provider_defaultContext = {
      createProject: async () => undefined,
      createProjectStatus: 'idle',
    };
    const FactoryContext = /*#__PURE__*/ (0, external_react_.createContext)(
      factory_provider_defaultContext
    );
    function FactoryProvider({ children }) {
      const factory = hooks_useMoonpageFactoryContract();
      const { 0: createProjectStatus, 1: setCreateProjectStatus } = (0,
      external_react_.useState)();
      const createProject = (0, external_react_.useCallback)(
        async ({
          title,
          textIpfsHash,
          originalLanguage,
          ...
          try {
            ...
            factory.provider.once(hash, async (transaction) => {
              ...
              const CreationEvent =
                (ref = receipt.events) === null || ref === void 0
                  ? void 0
                  : ref.find((event) => event.event === 'Created');
              ...
              const project =
                projectId ||
                (latestProjectId === null || latestProjectId === void 0
                  ? void 0
                  : latestProjectId.toString());
              try {
