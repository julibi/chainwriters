...
export const RPC_URLS: { [chainId: number]: string } = {
  1: process.env.NEXT_URL_RPC_URL_ETH_MAINNET,
  42: process.env.NEXT_URL_RPC_URL_ETH_RINKEBY,
  137: process.env.NEXT_URL_RPC_URL_POLYGON_MAINNET,
  80001: process.env.NEXT_URL_RPC_URL_POLYGON_MUMBAI
};
