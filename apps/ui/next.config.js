...
const nextConfig = {
  ...
  env: {
    NEXT_PUBLIC_RPC_URL_POLYGON_MAINNET_INFURA: process.env.NX_PUBLIC_RPC_URL_POLYGON_MAINNET_INFURA,
    NEXT_PUBLIC_RPC_URL_POLYGON_MUMBAI_INFURA: process.env.NX_PUBLIC_RPC_URL_POLYGON_MUMBAI_INFURA,
    NEXT_PUBLIC_RPC_URL_POLYGON_MAINNET_ALCHEMY: process.env.NX_PUBLIC_RPC_URL_POLYGON_MAINNET_ALCHEMY,
    NEXT_PUBLIC_RPC_URL_POLYGON_MUMBAI_ALCHEMY: process.env.NX_PUBLIC_RPC_URL_POLYGON_MUMBAI_ALCHEMY,
    ...
    NEXT_PUBLIC_PINATA_UNPIN_API_URL: process.env.NX_PUBLIC_PINATA_UNPIN_API_URL,
