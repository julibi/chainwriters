...
export class BallotCreated extends ethereum.Event {
  get params(): BallotCreated__Params {
    return new BallotCreated__Params(this);
  }
}

export class BallotCreated__Params {
  _event: BallotCreated;

  constructor(event: BallotCreated) {
    this._event = event;
  }
...
export class BallotsFactory extends ethereum.SmartContract {
  static bind(address: Address): BallotsFactory {
    return new BallotsFactory("BallotsFactory", address);
  }
  ...
  ballots(param0: BigInt): Address {
    let result = super.call("ballots", "ballots(uint256):(address)", [
  ...
  try_ballots(param0: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall("ballots", "ballots(uint256):(address)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  ballotsLength(): BigInt {
    let result = super.call("ballotsLength", "ballotsLength():(uint256)", []);

    return result[0].toBigInt();
  }

  try_ballotsLength(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "ballotsLength",
      "ballotsLength():(uint256)",
      []
    );
    if (result.reverted) {
      return new ethereum.CallResult();
...
export class CreateBallotCall extends ethereum.Call {
  get inputs(): CreateBallotCall__Inputs {
    return new CreateBallotCall__Inputs(this);
  }

  get outputs(): CreateBallotCall__Outputs {
    return new CreateBallotCall__Outputs(this);
  }
}

export class CreateBallotCall__Inputs {
  _call: CreateBallotCall;

  constructor(call: CreateBallotCall) {
    this._call = call;
  }
...
export class CreateBallotCall__Outputs {
  _call: CreateBallotCall;
